...
class EquivClassesVirtualMethods( EquivClassesFixedMethods ):
    ...
    def matchesCriteriaOfEquivClass(self, classname, item1, item2='', item3='') : pureVirtual()
...
class Colors():
    ...
    def getBasedUponTime(self, row):
        ...
        elif time=='6:00 pm'    : color_row = 'lightgreen'
...
def colorRow( self, col, which ):
    fieldnames = [ x.fieldname for x in self.config_columns ]

    if 'day' in fieldnames:
        for i in range(0, len(col)-1):
            fieldname = self.config_columns[i].fieldname
            if fieldname == 'day':
                if   col[i]=='Sunday'         : color_row = 'lightpink'
                elif col[i]=='Monday'         : color_row = '#FEF1B5'
                elif col[i]=='Tuesday'        : color_row = '#FFDAB9'
                elif col[i]=='Wednesday'      : color_row = '#EED2EE'
                elif col[i]=='Thursday'       : color_row = '#DAF4F0'
                elif col[i]=='Friday'         : color_row = '#E6E6FA'
                elif col[i]=='Saturday'       : color_row = '#CCFFCC'
                elif col[i]=='as&nbsp;needed' : color_row = 'lightgrey'
                else                          : color_row = 'red'
        ...
        for i in range(0, len(col)-1):
            fieldname = self.config_columns[i].fieldname
            if fieldname == 'time':
                if   col[i]=='7:00&nbsp;am'    : color_row = 'lightpink'
                elif col[i]=='8:00&nbsp;am'    : color_row = '#FEF1B5'
                elif col[i]=='9:00&nbsp;am'    : color_row = '#FFDAB9'
                elif col[i]=='11:00&nbsp;am'   : color_row = 'lightyellow'
                elif col[i]=='12:00&nbsp;noon' : color_row = '#EED2EE'
                elif col[i]=='4:00&nbsp;pm'    : color_row = '#DAF4F0'
                elif col[i]=='5:00&nbsp;pm'    : color_row = '#E6E6FA'
                elif col[i]=='6:00&nbsp;pm'    : color_row = 'lightgreen'
                elif col[i]=='8:00&nbsp;pm'    : color_row = '#CCFFCC'
                elif col[i]=='9:00&nbsp;pm'    : color_row = '#EED2EE'
                elif col[i]=='10:00&nbsp;pm'   : color_row = '#BFEFFF'
                elif col[i]=='as&nbsp;needed'  : color_row = 'lightgrey'
                else                           : color_row = 'red'
